...
public class Products_Supplier_GUI extends javax.swing.JFrame {

    private DataBase dataBase;
    private Supplier supplier;


    public Products_Supplier_GUI(DataBase dataBase, Supplier supplier) {
    ...
    private void initComponents() {
        ...
        actionComboBox = new javax.swing.JComboBox(new String[] { "add", "edit", "delete" });
        ...
        jLabel1.setText("Products Supplier Page");
    ...
    private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {
        // Navigate back to the previous frame, SupplierFrame, and update the database
        dataBase.updateSupplier(supplier);
        Supplier_GUI supplierFrame = new Supplier_GUI(dataBase, supplier);
    ...
    private void addProduct(String name, double price, boolean allergic) {
        ...
        supplier.getList().add(newProduct);
        JOptionPane.showMessageDialog(this, "Product added successfully.");
        dataBase.updateSupplier(supplier); // Ensure the product list is saved to the database
    }
    ...
    private void deleteProduct(String name) {
        for (Product product : supplier.getList()) {
            if (product.getName().equals(name)) {
                supplier.getList().remove(product);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Products_Supplier_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Supplier supplier = new Supplier("John Doe", "password", "email@example.com", "New York"); // Replace with actual supplier instance
                new Products_Supplier_GUI(dataBase, supplier).setVisible(true);
            }
        });
    }
